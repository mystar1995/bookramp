...
export default function AlertComponent(props)
{
    ...
    return (
        <Alert 
          ...
          confirmButtonTextStyle={{fontSize:responsivetext(15),fontWeight:'bold',color:colors.primary,fontFamily:Platform.OS != 'ios'?'Quicksand-Regular':'Quicksand-Regular.ttf'}}
          confirmButtonStyle={{
